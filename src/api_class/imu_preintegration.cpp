...
//         sub_imu_ = nh_.subscribe("/imu/data", 1, &IMUPreintegration::imuCallback, this);
//         sub_preintegration_flag_ = nh_.subscribe("preintegration_flag", 100, &IMUPreintegration::flagCallback, this);
...
//     void IMUPreintegration::flagCallback(const geometry_msgs::PoseStampedConstPtr& stamped_pose){
//         unique_lock<mutex> lock(imu_mtx_);
